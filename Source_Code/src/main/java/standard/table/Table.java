...
public class Table extends NodeCreator{
	...
	public void addHeading(List<String> headings,String style) {
		
		TR heads=new TR();
		heads.setStyle(style);
		for(String currentHeading : headings) {
			if(heads.getContent()!=null)
			{
			TH heading=new TH();
	...
	public void addData(List<String> bodyData,String style,String bodyStyle) {
